...
IUSE="+anacron dinit +inotify pam selinux systemd"
...
pkg_postinst() {
	...
	if [[ -n "${REPLACING_VERSIONS}" ]] ; then
		if ! use dinit; then
			ewarn "You should restart the ${PN} daemon or else you might experience segfaults"
		else
			ewarn "You should restart the crond service or else you might experience segfaults"
		fi

		ewarn "or ${PN} might not work reliably anymore."
