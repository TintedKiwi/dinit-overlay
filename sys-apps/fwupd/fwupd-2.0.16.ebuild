...
IUSE="amdgpu +archive bash-completion bluetooth cbor dinit elogind flashrom gnutls gtk-doc introspection lzma man minimal modemmanager nvme policykit protobuf seccomp spi synaptics systemd test tpm uefi"
