...
COMMON_DEPEND="
	...
	>=sys-auth/elogind-255.17[dinit,pam,turnstile]
"
RDEPEND="${COMMON_DEPEND}
	>=net-misc/iputils-20250605-r1
	>=sys-apps/dbus-1.16.2[dinit,elogind]
...
"
PDEPEND="
	>=sys-auth/seatd-0.9.1[builtin,dinit,elogind,server]
	>=sys-auth/turnstile-0.1.10
"

PATCHES=(
	"${FILESDIR}"/update-distro-name.patch
